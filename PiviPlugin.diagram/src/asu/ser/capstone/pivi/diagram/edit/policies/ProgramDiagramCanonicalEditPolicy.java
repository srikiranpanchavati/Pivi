 ...
 * @generated
 */
public class ProgramDiagramCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(PiviPackage.eINSTANCE.getProgramDiagram_Statements());
			myFeaturesToSynchronize.add(PiviPackage.eINSTANCE.getProgramDiagram_Start());
			myFeaturesToSynchronize.add(PiviPackage.eINSTANCE.getProgramDiagram_End());
		}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PiviNodeDescriptor> childDescriptors = PiviDiagramUpdater
				.getProgramDiagram_1000SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PiviNodeDescriptor> childDescriptors = PiviDiagramUpdater
				.getProgramDiagram_1000SemanticChildren((View) getHost().getModel());
	...
	*/
	private Collection<PiviLinkDescriptor> collectAllLinks(View view, Domain2Notation domain2NotationMap) {
		if (!ProgramDiagramEditPart.MODEL_ID.equals(PiviVisualIDRegistry.getModelID(view))) {
		...
		case ProgramDiagramEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getProgramDiagram_1000ContainedLinks(view));
			}
		...
		case IfStatementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getIfStatement_2001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case InstructionStatementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getInstructionStatement_2002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case WhileStatementEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getWhileStatement_2003ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case StartEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getStart_2004ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case EndEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getEnd_2005ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case StatementOutputEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getStatementOutput_4001ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
		case StatementInputEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(PiviDiagramUpdater.getStatementInput_4002ContainedLinks(view));
			}
			domain2NotationMap.putView(view.getElement(), view);
			break;
		}
